    ...
    <section id="about">
      <div className="container w-2/3 py-10 mx-auto text-center">
        ...
        <div className="flex flex-wrap -m-4 justify-center items-center gap-16">
          <div className="xl:w-1/3 w-2/3 justify-center">
            <img
          ...
          <div className="lg:flex-grow lg:w-1/2 w-full flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center justify-center text-center">
